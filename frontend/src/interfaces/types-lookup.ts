...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletTemplateEvent (43) */
  interface PalletTemplateEvent extends Enum {
    readonly isArtistRegistered: boolean;
    readonly asArtistRegistered: AccountId32;
    readonly isCollectionCreated: boolean;
    readonly asCollectionCreated: ITuple<[u32, AccountId32]>;
    readonly isNftMinted: boolean;
    readonly asNftMinted: ITuple<[u32, u32, AccountId32]>;
    readonly isNftTransferred: boolean;
    readonly asNftTransferred: ITuple<[u32, u32, AccountId32, AccountId32]>;
    readonly type: 'ArtistRegistered' | 'CollectionCreated' | 'NftMinted' | 'NftTransferred';
  }
  ...
  /** @name FrameSupportTokensMiscIdAmountRuntimeHoldReason (101) */
  interface FrameSupportTokensMiscIdAmountRuntimeHoldReason extends Struct {
    readonly id: SolochainTemplateRuntimeRuntimeHoldReason;
    readonly amount: u128;
  }

  /** @name SolochainTemplateRuntimeRuntimeHoldReason (102) */
  type SolochainTemplateRuntimeRuntimeHoldReason = Null;

  /** @name FrameSupportTokensMiscIdAmountRuntimeFreezeReason (105) */
  interface FrameSupportTokensMiscIdAmountRuntimeFreezeReason extends Struct {
    readonly id: SolochainTemplateRuntimeRuntimeFreezeReason;
    readonly amount: u128;
  }

  /** @name SolochainTemplateRuntimeRuntimeFreezeReason (106) */
  type SolochainTemplateRuntimeRuntimeFreezeReason = Null;
  ...
  /** @name PalletBalancesAdjustmentDirection (114) */
  ...
  interface PalletTemplateCall extends Enum {
    readonly isRegisterArtist: boolean;
    ...
    readonly type: 'RegisterArtist' | 'CreateCollection' | 'MintNft' | 'TransferNft';
  }
  ...
  /** @name PalletTemplateCollection (122) */
  interface PalletTemplateCollection extends Struct {
    readonly creator: AccountId32;
    readonly metadata: Bytes;
  }

  /** @name PalletTemplateNft (124) */
  interface PalletTemplateNft extends Struct {
    readonly owner: AccountId32;
    readonly metadata: Bytes;
  }

  /** @name PalletTemplateError (125) */
  interface PalletTemplateError extends Enum {
    readonly isNftNotFound: boolean;
    readonly isNotNFTOwner: boolean;
    readonly isNotRegisteredArtist: boolean;
    readonly isCollectionNotFound: boolean;
    readonly isAlreadyRegistered: boolean;
    readonly type: 'NftNotFound' | 'NotNFTOwner' | 'NotRegisteredArtist' | 'CollectionNotFound' | 'AlreadyRegistered';
  }
  ...
  /** @name FrameMetadataHashExtensionCheckMetadataHash (139) */
  interface FrameMetadataHashExtensionCheckMetadataHash extends Struct {
    readonly mode: FrameMetadataHashExtensionMode;
  }

  /** @name FrameMetadataHashExtensionMode (140) */
  ...
  /** @name SolochainTemplateRuntimeRuntime (142) */
