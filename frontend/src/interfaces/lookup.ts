...
export default {
  ...
  /**
   * Lookup43: pallet_template::pallet::Event<T>
   **/
  PalletTemplateEvent: {
    _enum: {
      ArtistRegistered: 'AccountId32',
      CollectionCreated: '(u32,AccountId32)',
      NFTMinted: '(u32,u32,AccountId32)',
      NFTTransferred: '(u32,u32,AccountId32,AccountId32)'
    }
  },
  /**
   * Lookup44: frame_system::Phase
   **/
  FrameSystemPhase: {
    _enum: {
      ApplyExtrinsic: 'u32',
  ...
  /**
   * Lookup101: frame_support::traits::tokens::misc::IdAmount<solochain_template_runtime::RuntimeHoldReason, Balance>
   **/
  FrameSupportTokensMiscIdAmountRuntimeHoldReason: {
    id: 'SolochainTemplateRuntimeRuntimeHoldReason',
    amount: 'u128'
  },
  /**
   * Lookup102: solochain_template_runtime::RuntimeHoldReason
   **/
  SolochainTemplateRuntimeRuntimeHoldReason: 'Null',
  /**
   * Lookup105: frame_support::traits::tokens::misc::IdAmount<solochain_template_runtime::RuntimeFreezeReason, Balance>
   **/
  FrameSupportTokensMiscIdAmountRuntimeFreezeReason: {
    id: 'SolochainTemplateRuntimeRuntimeFreezeReason',
    amount: 'u128'
  },
  /**
   * Lookup106: solochain_template_runtime::RuntimeFreezeReason
   **/
  SolochainTemplateRuntimeRuntimeFreezeReason: 'Null',
  /**
  ...
  /**
   * Lookup114: pallet_balances::types::AdjustmentDirection
   **/
  ...
  /**
   * Lookup122: pallet_template::pallet::Collection<sp_core::crypto::AccountId32>
   **/
  PalletTemplateCollection: {
    creator: 'AccountId32',
    metadata: 'Bytes'
  },
  /**
   * Lookup124: pallet_template::pallet::NFT<sp_core::crypto::AccountId32>
   **/
  PalletTemplateNft: {
    owner: 'AccountId32',
    metadata: 'Bytes'
  ...
  /**
   * Lookup125: pallet_template::pallet::Error<T>
   **/
  PalletTemplateError: {
    _enum: ['NFTNotFound', 'NotNFTOwner', 'NotRegisteredArtist', 'CollectionNotFound', 'AlreadyRegistered']
  },
  /**
  ...
  /**
   * Lookup139: frame_metadata_hash_extension::CheckMetadataHash<T>
   **/
  FrameMetadataHashExtensionCheckMetadataHash: {
    mode: 'FrameMetadataHashExtensionMode'
  },
  /**
   * Lookup140: frame_metadata_hash_extension::Mode
   **/
  FrameMetadataHashExtensionMode: {
    _enum: ['Disabled', 'Enabled']
  },
  /**
   * Lookup142: solochain_template_runtime::Runtime
   **/
